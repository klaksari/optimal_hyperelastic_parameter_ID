...
[lambda1, lambda2] = meshgrid(linspace(lambda_min, lambda_max, 128));
...
% First Pair
compute_cond1 = @(lam1, lam2) sqrt(cond(transpose([2 * (lam1 - 1 / lam1^2), -2 * (1/lam1^3 - 1);
                                                   2 * (lam2 - 1 / lam2^2), -2 * (1/lam2^3 - 1)])*...
                                                  [2 * (lam1 - 1 / lam1^2), -2 * (1/lam1^3 - 1);
                                                   2 * (lam2 - 1 / lam2^2), -2 * (1/lam2^3 - 1)]));
det1 = @(lam1, lam2) sqrt(abs(det(transpose([2 * (lam1 - 1 / lam1^2), -2 * (1/lam1^3 - 1);
                                             2 * (lam2 - 1 / lam2^2), -2 * (1/lam2^3 - 1)])*...
                                            [2 * (lam1 - 1 / lam1^2), -2 * (1/lam1^3 - 1);
                                             2 * (lam2 - 1 / lam2^2), -2 * (1/lam2^3 - 1)])));
...
view(2); colormap winter; colorbar; axis square;
xlabel('\lambda^1'); ylabel('\lambda^2'); xlim([lambda_min, lambda_max]); ylim([lambda_min, lambda_max]); clim([1, 20]);
...
% Second Pair
compute_cond2 = @(lam1, lam2) sqrt(cond(transpose([2 * (lam1 - 1 / lam1^3), -2 * (1 / lam1^3 - lam1);
                                                   2 * (1 - 1 / lam1^2), -2 * (1 - lam1^2);
                                                   2 * (lam2 - 1 / lam2^3), -2 * (1 / lam2^3 - lam2); ...
                                                   2 * (1 - 1 / lam2^2), -2 * (1 - lam2^2)]) * ...
                                                  [2 * (lam1 - 1 / lam1^3), -2 * (1 / lam1^3 - lam1);
                                                   2 * (1 - 1 / lam1^2), -2 * (1 - lam1^2);
                                                   2 * (lam2 - 1 / lam2^3), -2 * (1 / lam2^3 - lam2); ...
                                                   2 * (1 - 1 / lam2^2), -2 * (1 - lam2^2)]));
det2 = @(lam1, lam2) sqrt(abs(det(transpose([2 * (lam1 - 1 / lam1^3), -2 * (1 / lam1^3 - lam1);
                                             2 * (1 - 1 / lam1^2), -2 * (1 - lam1^2);
                                             2 * (lam2 - 1 / lam2^3), -2 * (1 / lam2^3 - lam2); ...
                                             2 * (1 - 1 / lam2^2), -2 * (1 - lam2^2)]) * ...
                                            [2 * (lam1 - 1 / lam1^3), -2 * (1 / lam1^3 - lam1);
...
% Third Pair
compute_cond3 = @(lam1, lam2) sqrt(cond(transpose([2 * (lam1 - 1 / lam1^5), -2 * (1 / lam1^3 - lam1^3);
                                                   2 * (lam2 - 1 / lam2^5), -2 * (1 / lam2^3 - lam2^3)]) * ...
                                                  [2 * (lam1 - 1 / lam1^5), -2 * (1 / lam1^3 - lam1^3);
                                                   2 * (lam2 - 1 / lam2^5), -2 * (1 / lam2^3 - lam2^3)]));
det3 = @(lam1, lam2) sqrt(abs(det(transpose([2 * (lam1 - 1 / lam1^5), -2 * (1 / lam1^3 - lam1^3);
                                             2 * (lam2 - 1 / lam2^5), -2 * (1 / lam2^3 - lam2^3)]) * ...
                                            [2 * (lam1 - 1 / lam1^5), -2 * (1 / lam1^3 - lam1^3);
                                             2 * (lam2 - 1 / lam2^5), -2 * (1 / lam2^3 - lam2^3)])));
...
% Fourth Pair
compute_cond4 = @(lam1, lam2) sqrt(cond(transpose([2 * (lam1 - 1 / (lam1^3 * lam2)), -2 * (1 / lam1^3 - lam1 * lam2^2);
                                                   2 * (lam2 - 1 / (lam1 * lam2^3)), -2 * (1 / lam2^3 - lam1^2 * lam2)]) * ...
                                                  [2 * (lam1 - 1 / (lam1^3 * lam2)), -2 * (1 / lam1^3 - lam1 * lam2^2);
                                                   2 * (lam2 - 1 / (lam1 * lam2^3)), -2 * (1 / lam2^3 - lam1^2 * lam2)]));
det4 = @(lam1, lam2) sqrt(abs(det(transpose([2 * (lam1 - 1 / (lam1^3 * lam2)), -2 * (1 / lam1^3 - lam1 * lam2^2);
                                             2 * (lam2 - 1 / (lam1 * lam2^3)), -2 * (1 / lam2^3 - lam1^2 * lam2)]) * ...
                                            [2 * (lam1 - 1 / (lam1^3 * lam2)), -2 * (1 / lam1^3 - lam1 * lam2^2);
                                             2 * (lam2 - 1 / (lam1 * lam2^3)), -2 * (1 / lam2^3 - lam1^2 * lam2)])));
...
view(2); colormap winter; colorbar; axis square;
xlabel('\lambda_1'); ylabel('\lambda_2'); xlim([lambda_min, lambda_max]); ylim([lambda_min, lambda_max]); clim([1, 20]);
